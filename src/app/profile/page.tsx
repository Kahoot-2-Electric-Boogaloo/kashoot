    ...
    <div className='bg-background-alt h-screen flex flex-col items-center justify-center'>
      {user && (
        <div className='text-center'>
          <div
            className='relative w-28 m-auto hover:text-accent hover:opacity-75'
          ...
          >
            ...
            {user.photoURL && (
              <img
                ...
                className='w-28 h-28 rounded-full mb-4 cursor-pointer ease-linear border-2 hover:border-2 hover:border-accent'
              />
            )}
          </div>
          ...
          {isUploadMenuOpen && (
            <div
              ref={uploadMenuRef}
              className='bg-background w-100 p-4 rounded-md mt-4 mb-2'
            >
              <input
                type='file'
                accept='image/*'
